package com.sap.solman.reportengine.config;
...
@Configuration
@EnableWebMvc
@ComponentScan(basePackages = "com.sap.solman.reportengine") // includes sub packages
public class WebAppContextConfig {
    ...
    */
    ...
    @Bean
    public BirtEngineFactory getBirtEngineFactory(){
